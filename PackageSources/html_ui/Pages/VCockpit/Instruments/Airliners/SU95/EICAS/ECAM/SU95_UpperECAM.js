...
(function (A320_Neo_UpperECAM) {
    ...
    class Display extends Airliners.EICASTemplateElement {
        ...
        init() {
            ...
            this.secondaryEcamMessage = {
                ...
                normal: [
                    ...
                    },
                    {
                        message: "LDG LT",
                        isActive: () => (
                            this.getCachedSimVar("LIGHT LANDING:2", "Bool") ||
                            this.getCachedSimVar("LIGHT LANDING:3", "Bool")
                        ),
                    },
                    {
                        message: "BRK FAN",
            ...
            this.takeoffMemo = new A320_Neo_UpperECAM.Memo(this, "to-memo", "T.O", [
                ...
                new A320_Neo_UpperECAM.MemoItem(
                    ...
                    "T.O",
                    "T.O",
                    () => this.getCachedSimVar("L:A32NX_FLAPS_HANDLE_INDEX", "Enum") >= 1 && this.getCachedSimVar("L:A32NX_FLAPS_HANDLE_INDEX", "Enum") <= 2 //no flaps 3 take-off on SSJ
                ),
                new A320_Neo_UpperECAM.MemoItem(
                    "to-memo-config",
                    "T.O CONFIG",
        ...
        updateTakeoffConfigWarnings(_test) {
            ...
            if (flapsLeft > 24 || flapsLeft < 1 || flapsRight > 24 || flapsRight < 1) {
    ...
    class FlapsPanel extends A320_Neo_UpperECAM.PanelBase {
        constructor() {
            ...
            this.slatDotPositions = [
                new Vec2(160, 37),
                new Vec2(110, 52),
                new Vec2(68, 65)//, Only 3 slat position for SSJ
                //new Vec2(26, 78)
            ];
        ...
        create() {
            ...
            this.targetSlatsArrowsStrings.push(this.generateArrowPathD(this.slatArrowPathD, null, this.slatDotPositions[1], this.slatDotPositions[2], 1));
            this.targetSlatsArrowsStrings.push(this.generateArrowPathD(this.slatArrowPathD, null, this.slatDotPositions[2], this.slatDotPositions[2], 1));
        ...
        update(_deltaTime) {
            super.update(_deltaTime);
            const slatsAngle = Math.max(0, Math.min(24, (SimVar.GetSimVarValue("LEADING EDGE FLAPS LEFT ANGLE", "degrees") + SimVar.GetSimVarValue("LEADING EDGE FLAPS RIGHT ANGLE", "degrees")) * 0.5)); //change for SSJ
            ...
            if ((slatsAngleChanged || flapsAngleChanged) && ((this.cockpitSettings != null) && (this.cockpitSettings.FlapsLevels != null) && this.cockpitSettings.FlapsLevels.initialised)) {
                if (slatsAngleChanged) {
                    ...
                    if (this.currentSlatsAngle <= this.cockpitSettings.FlapsLevels.slatsAngle[0]) {
                        ...
                        var lerp = Utils.Clamp((this.currentSlatsAngle - 18) / 6, 0, 1);
                ...
                if (flapsAngleChanged) {
                    ...
                    let dFlapsArrow = ""; //change for SSJ
                    if (this.currentFlapsAngle <= this.cockpitSettings.FlapsLevels.flapsAngle[0]) {
                        ...
                        var lerp = Utils.Clamp(this.currentFlapsAngle / 9, 0, 1);
                        ...
                        var lerp = Utils.Clamp((this.currentFlapsAngle - 9) / 8, 0, 1);
                        ...
                        var lerp = Utils.Clamp((this.currentFlapsAngle - 17) /8, 0, 1);
                        ...
                        var lerp = Utils.Clamp((this.currentFlapsAngle - 25) / 11, 0, 1);
