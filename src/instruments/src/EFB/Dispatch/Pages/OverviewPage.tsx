        ...
        <div className="flex mt-6">
            <div className="w-1/2 mr-3">
                <div className="text-white overflow-hidden bg-navy-lighter rounded-2xl shadow-lg p-6 h-efb-nav">
                    <h2 className="text-2xl font-medium">Sukhoi Superjet 100</h2>
                    ...
                    <div className="mt-8 flex">
                        <div className="w-1/2">
                            ...
                            <span className="mt-2 text-lg">RRJ-95LR [SU95]</span>
                            ...
                            <span className="mt-2 text-lg">2472 [nm]</span>
                            ...
                            <span className="mt-2 text-lg">49,625 [kg]</span>
                            ...
                            <span className="mt-2 text-lg">40,000 [kg]</span>
                            ...
                            <span className="mt-2 text-lg">98</span>
                        </div>
                        <div className="w-1/2">
                            <h3 className="text-xl font-medium flex items-center">
                            ...
                            <span className="mt-2 text-lg">SaM146-1S18</span>
                            ...
                            <span className="mt-2 text-lg">0.81</span>
                            ...
                            <span className="mt-2 text-lg">49,450 [kg]</span>
                            ...
                            <span className="mt-2 text-lg">15,805 [l]</span>
                            ...
                            <span className="mt-2 text-lg">T.B.D. [kg]</span>
                        </div>
                    </div>
                </div>
            </div>
